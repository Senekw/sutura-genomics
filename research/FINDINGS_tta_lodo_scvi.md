...
_Generated 2026-07-11T01:02:41Z on branch `foundation-features`._
...
**Headline.** Self-supervised TTA moves held-out error 7.28 -> 4.20 pitches (PASTE2 5.28). It **CLOSES the gap (reaches PASTE2)** (-3.07 vs no-TTA, -1.08 vs PASTE2; 1/1 folds beat PASTE2).
