...
_Generated 2026-07-11T00:14:53Z on branch `foundation-features`._
...
**Headline.** Self-supervised TTA moves held-out error 8.18 -> 7.68 pitches (PASTE2 4.81). It **narrows the gap but does NOT reach PASTE2** (-0.49 vs no-TTA, +2.87 vs PASTE2; 0/2 folds beat PASTE2).
