...
_Generated 2026-07-10T23:51:57Z on branch `foundation-features`._
...
**Headline.** Self-supervised TTA moves held-out error 8.53 -> 6.45 pitches (PASTE2 5.28). It **narrows the gap but does NOT reach PASTE2** (-2.08 vs no-TTA, +1.17 vs PASTE2; 0/1 folds beat PASTE2).
