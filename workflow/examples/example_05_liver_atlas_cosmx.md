...
> Input: _Building a spatial cell atlas of human liver with CosMx 6000-plex across 20 donors, want harmonized cell types and spatial domains, matched scRNA reference available_

## What we understood from your description

| Field | Value |
|---|---|
| Platform | NanoString CosMx SMI (confidence: high) |
| Experiment type | Atlas building / reference construction (confidence: high) |
| Tissue | liver |
| Serial sections | no |
| Samples/donors/conditions | 20 |
| Stated goals | batch_correction, cell_typing, spatial_domains |
| Inferred goals | none |
| Single-cell reference | yes |
...
> ⚠️ CosMx has notable background; filter aggressively on negative-probe counts.
> ⚠️ Platform note: Higher background than other imaging platforms; aggressive negative-probe filtering needed. Segmentation quality varies by tissue.
...
_Why here:_ You have 20 sections/samples; multiple sections/samples must be integrated into a shared embedding so that differences are biology, not batch.
